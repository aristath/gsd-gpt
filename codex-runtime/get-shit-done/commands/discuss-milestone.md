...
3. Follow discuss-milestone.md workflow with **ALL questions using ask the user**:
   - Use ask the user: "What do you want to add, improve, or fix?" with feature categories
   - Use ask the user to dig into features they mention
   - Use ask the user to help them articulate what matters most
